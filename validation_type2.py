...
def main():
    parser = argparse.ArgumentParser(
        description="Document Validator using LLMs.",
        formatter_class=argparse.RawTextHelpFormatter
    )
    parser.add_argument(
        "--config_file",
        default="configs_UG2.json",
    ...
    if validation_mode == "SECTIONS":
        ...
        print(f"[Error] Invalid 'validation_mode': '{validation_mode}' in profile '{active_profile_name}'. Must be 'SECTIONS' or 'RAW_TEXT'.")
